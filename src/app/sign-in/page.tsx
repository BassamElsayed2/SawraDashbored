...
export default function SignInPage() {
  ...
  return (
    <>
      <DarkMode />
      {showError && (
        <div className="fixed top-5 left-1/2 z-50 mx-4 w-full max-w-md -translate-x-1/2 rounded-2xl border border-danger-200 bg-white px-5 py-4 shadow-xl dark:border-danger-800 dark:bg-[#0c1427]">
            <button
              onClick={() => {
                setShowError(false);
                router.replace("/sign-in/");

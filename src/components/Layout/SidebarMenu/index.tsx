          ...
          <div className="accordion">
            ...
            <div className="accordion-item rounded-md text-black dark:text-white mb-[5px] whitespace-nowrap">
              ...
              >
                ...
                <span className="title leading-none">التقييمات</span>
              </button>
                ...
                <ul className="sidebar-sub-menu">
                  ...
                  >
                    <li className="sidemenu-item mb-[4px] last:mb-0">
                      ...
                      >
                        <i className="ri-feedback-line transition-all text-gray-500 dark:text-gray-400 ltr:mr-[7px] rtl:ml-[7px] !text-[22px] leading-none relative -top-px"></i>
                        لوحة تحكم التقييمات
                      </Link>
                    </li>
                  </div>
            ...
            <div className="accordion-item rounded-md text-black dark:text-white mb-[5px] whitespace-nowrap">
              ...
              >
                ...
                <span className="title leading-none">الطلبات</span>
              </button>
                ...
                <ul className="sidebar-sub-menu">
                  ...
                  >
                    <li className="sidemenu-item mb-[4px] last:mb-0">
                      ...
                      >
                        <i className="ri-list-check transition-all text-gray-500 dark:text-gray-400 ltr:mr-[7px] rtl:ml-[7px] !text-[22px] leading-none relative -top-px"></i>
                        قائمة الطلبات
                      </Link>
                    </li>
                  </div>
            ...
            <div className="accordion-item rounded-md text-black dark:text-white mb-[5px] whitespace-nowrap">
              <button
                ...
                className={`accordion-button flex items-center transition-all py-[9px] ltr:pl-[14px] ltr:pr-[30px] rtl:pr-[14px] rtl:pl-[30px] rounded-md font-medium w-full relative hover:bg-gray-50 text-left dark:hover:bg-[#15203c] disabled:opacity-50 disabled:cursor-not-allowed ${
                  pathname === "/" ? "active" : ""
                }`}
              >
                <i className="material-symbols-outlined transition-all text-gray-500 dark:text-gray-400 ltr:mr-[7px] rtl:ml-[7px] !text-[22px] leading-none relative -top-px">
